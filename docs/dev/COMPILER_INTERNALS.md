...
| `g_dce` | :30951 | `main` |  |
| `g_dce_end` | :30977 | `dce_emit_module`, `dce_free` |  |
| `g_dce_keep` | :30962 | `main` | `--keep=a,b,c` — extra DCE roots.  The pass's root set is `main` plus whatever module-scope constants name. Th |
| `g_dce_live` | :30978 | `dce_emit_module`, `dce_free` |  |
| `g_dce_map` | :30981 | `dce_emit_module`, `dce_free` |  |
| `g_dce_mod` | :30975 | `dce_emit_module` | The module text, as an integer cast of a BORROWED `s`. Deliberately not a `: ~ s` global: a mutable string glo |
| `g_dce_qn` | :30980 | `__dce_mark_name`, `dce_emit_module` |  |
| `g_dce_queue` | :30979 | `dce_emit_module`, `dce_free` |  |
| `g_dce_start` | :30976 | `dce_emit_module`, `dce_free` |  |
...
| `g_input_key` | :31106 | `main` |  |
| `g_input_source` | :31105 | `main` | Borrowed aliases to main's live source/key bindings when --stdin supplies an overlay. Every source read (inclu |
...
| `g_origin_functions` | :22376 | `main` |  |
| `g_origin_nodes` | :22374 | `origin_free`, `origin_new` | Return-escape inference (docs/MEMORY.md §2.8): record that the enclosing function may RETURN this bare-identif |
| `g_origin_returns` | :22377 | `main` |  |
| `g_origin_work` | :22375 | `origin_free`, `origin_queue`, `origin_resolve` |  |
...
| `g_sanitize_address` | :31100 | `main` | Emission policy, set by main's --sanitize-address flag. |
| `g_split_fh` | :30971 | `__sp_close`, `__sp_open` |  |
| `g_split_fill` | :30969 | `split_emit_module` |  |
| `g_split_max` | :30965 | `main` |  |
| `g_split_min` | :30966 | `main` |  |
| `g_split_n` | :30964 | `__sp_whole`, `dce_emit_module`, `split_emit_module` | Partitioned emission — see "Partitioned emission" below. |
| `g_split_out` | :30967 | `main` |  |
| `g_split_part` | :30968 | `split_emit_module` |  |
| `g_split_priv` | :30970 | `split_emit_module` |  |
