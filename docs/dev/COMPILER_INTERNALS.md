...
| `g_dce` | :30817 | `main` |  |
| `g_dce_end` | :30843 | `dce_emit_module`, `dce_free` |  |
| `g_dce_keep` | :30828 | `main` | `--keep=a,b,c` — extra DCE roots.  The pass's root set is `main` plus whatever module-scope constants name. Th |
| `g_dce_live` | :30844 | `dce_emit_module`, `dce_free` |  |
| `g_dce_map` | :30847 | `dce_emit_module`, `dce_free` |  |
| `g_dce_mod` | :30841 | `dce_emit_module` | The module text, as an integer cast of a BORROWED `s`. Deliberately not a `: ~ s` global: a mutable string glo |
| `g_dce_qn` | :30846 | `__dce_mark_name`, `dce_emit_module` |  |
| `g_dce_queue` | :30845 | `dce_emit_module`, `dce_free` |  |
| `g_dce_start` | :30842 | `dce_emit_module`, `dce_free` |  |
...
| `g_input_key` | :30972 | `main` |  |
| `g_input_source` | :30971 | `main` | Borrowed aliases to main's live source/key bindings when --stdin supplies an overlay. Every source read (inclu |
...
| `g_origin_functions` | :22349 | `main` |  |
| `g_origin_nodes` | :22347 | `origin_free`, `origin_new` | Return-escape inference (docs/MEMORY.md §2.8): record that the enclosing function may RETURN this bare-identif |
| `g_origin_returns` | :22350 | `main` |  |
| `g_origin_work` | :22348 | `origin_free`, `origin_queue`, `origin_resolve` |  |
...
| `g_sanitize_address` | :30966 | `main` | Emission policy, set by main's --sanitize-address flag. |
| `g_split_fh` | :30837 | `__sp_close`, `__sp_open` |  |
| `g_split_fill` | :30835 | `split_emit_module` |  |
| `g_split_max` | :30831 | `main` |  |
| `g_split_min` | :30832 | `main` |  |
| `g_split_n` | :30830 | `__sp_whole`, `dce_emit_module`, `split_emit_module` | Partitioned emission — see "Partitioned emission" below. |
| `g_split_out` | :30833 | `main` |  |
| `g_split_part` | :30834 | `split_emit_module` |  |
| `g_split_priv` | :30836 | `split_emit_module` |  |
