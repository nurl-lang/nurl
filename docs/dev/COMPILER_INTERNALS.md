...
| `g_dce` | :30940 | `main` |  |
| `g_dce_end` | :30966 | `dce_emit_module`, `dce_free` |  |
| `g_dce_keep` | :30951 | `main` | `--keep=a,b,c` — extra DCE roots.  The pass's root set is `main` plus whatever module-scope constants name. Th |
| `g_dce_live` | :30967 | `dce_emit_module`, `dce_free` |  |
| `g_dce_map` | :30970 | `dce_emit_module`, `dce_free` |  |
| `g_dce_mod` | :30964 | `dce_emit_module` | The module text, as an integer cast of a BORROWED `s`. Deliberately not a `: ~ s` global: a mutable string glo |
| `g_dce_qn` | :30969 | `__dce_mark_name`, `dce_emit_module` |  |
| `g_dce_queue` | :30968 | `dce_emit_module`, `dce_free` |  |
| `g_dce_start` | :30965 | `dce_emit_module`, `dce_free` |  |
...
| `g_input_key` | :31095 | `main` |  |
| `g_input_source` | :31094 | `main` | Borrowed aliases to main's live source/key bindings when --stdin supplies an overlay. Every source read (inclu |
...
| `g_origin_functions` | :22365 | `main` |  |
| `g_origin_nodes` | :22363 | `origin_free`, `origin_new` | Return-escape inference (docs/MEMORY.md §2.8): record that the enclosing function may RETURN this bare-identif |
| `g_origin_returns` | :22366 | `main` |  |
| `g_origin_work` | :22364 | `origin_free`, `origin_queue`, `origin_resolve` |  |
...
| `g_sanitize_address` | :31089 | `main` | Emission policy, set by main's --sanitize-address flag. |
| `g_split_fh` | :30960 | `__sp_close`, `__sp_open` |  |
| `g_split_fill` | :30958 | `split_emit_module` |  |
| `g_split_max` | :30954 | `main` |  |
| `g_split_min` | :30955 | `main` |  |
| `g_split_n` | :30953 | `__sp_whole`, `dce_emit_module`, `split_emit_module` | Partitioned emission — see "Partitioned emission" below. |
| `g_split_out` | :30956 | `main` |  |
| `g_split_part` | :30957 | `split_emit_module` |  |
| `g_split_priv` | :30959 | `split_emit_module` |  |
