...
| `g_dce` | :31967 | `main` |  |
| `g_dce_end` | :31993 | `dce_emit_module`, `dce_free` |  |
| `g_dce_keep` | :31978 | `main` | `--keep=a,b,c` — extra DCE roots.  The pass's root set is `main` plus whatever module-scope constants name. Th |
| `g_dce_live` | :31994 | `dce_emit_module`, `dce_free` |  |
| `g_dce_map` | :31997 | `dce_emit_module`, `dce_free` |  |
| `g_dce_mod` | :31991 | `dce_emit_module` | The module text, as an integer cast of a BORROWED `s`. Deliberately not a `: ~ s` global: a mutable string glo |
| `g_dce_qn` | :31996 | `__dce_mark_name`, `dce_emit_module` |  |
| `g_dce_queue` | :31995 | `dce_emit_module`, `dce_free` |  |
| `g_dce_start` | :31992 | `dce_emit_module`, `dce_free` |  |
...
| `g_diag_ctx` | :124 | `__impl_sig_check`, `dyn_subst_parts`, `emit_missing_defaults`, `emit_one_instantiation` +2 | Diagnostic context suffix, appended to every die/warn message while non-empty. Set (and saved/restored — insta |
...
| `g_input_key` | :32122 | `main` |  |
| `g_input_source` | :32121 | `main` | Borrowed aliases to main's live source/key bindings when --stdin supplies an overlay. Every source read (inclu |
...
| `g_origin_functions` | :22958 | `main` |  |
| `g_origin_nodes` | :22956 | `origin_free`, `origin_new` | Return-escape inference (docs/MEMORY.md §2.8): record that the enclosing function may RETURN this bare-identif |
| `g_origin_returns` | :22959 | `main` |  |
| `g_origin_work` | :22957 | `origin_free`, `origin_queue`, `origin_resolve` |  |
...
| `g_sanitize_address` | :32116 | `main` | Emission policy, set by main's --sanitize-address flag. |
| `g_split_fh` | :31987 | `__sp_close`, `__sp_open` |  |
| `g_split_fill` | :31985 | `split_emit_module` |  |
| `g_split_max` | :31981 | `main` |  |
| `g_split_min` | :31982 | `main` |  |
| `g_split_n` | :31980 | `__sp_whole`, `dce_emit_module`, `split_emit_module` | Partitioned emission — see "Partitioned emission" below. |
| `g_split_out` | :31983 | `main` |  |
| `g_split_part` | :31984 | `split_emit_module` |  |
| `g_split_priv` | :31986 | `split_emit_module` |  |
