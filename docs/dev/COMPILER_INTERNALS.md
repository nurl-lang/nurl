...
| `g_dce` | :30959 | `main` |  |
| `g_dce_end` | :30985 | `dce_emit_module`, `dce_free` |  |
| `g_dce_keep` | :30970 | `main` | `--keep=a,b,c` — extra DCE roots.  The pass's root set is `main` plus whatever module-scope constants name. Th |
| `g_dce_live` | :30986 | `dce_emit_module`, `dce_free` |  |
| `g_dce_map` | :30989 | `dce_emit_module`, `dce_free` |  |
| `g_dce_mod` | :30983 | `dce_emit_module` | The module text, as an integer cast of a BORROWED `s`. Deliberately not a `: ~ s` global: a mutable string glo |
| `g_dce_qn` | :30988 | `__dce_mark_name`, `dce_emit_module` |  |
| `g_dce_queue` | :30987 | `dce_emit_module`, `dce_free` |  |
| `g_dce_start` | :30984 | `dce_emit_module`, `dce_free` |  |
...
| `g_input_key` | :31114 | `main` |  |
| `g_input_source` | :31113 | `main` | Borrowed aliases to main's live source/key bindings when --stdin supplies an overlay. Every source read (inclu |
...
| `g_origin_functions` | :22384 | `main` |  |
| `g_origin_nodes` | :22382 | `origin_free`, `origin_new` | Return-escape inference (docs/MEMORY.md §2.8): record that the enclosing function may RETURN this bare-identif |
| `g_origin_returns` | :22385 | `main` |  |
| `g_origin_work` | :22383 | `origin_free`, `origin_queue`, `origin_resolve` |  |
...
| `g_sanitize_address` | :31108 | `main` | Emission policy, set by main's --sanitize-address flag. |
| `g_split_fh` | :30979 | `__sp_close`, `__sp_open` |  |
| `g_split_fill` | :30977 | `split_emit_module` |  |
| `g_split_max` | :30973 | `main` |  |
| `g_split_min` | :30974 | `main` |  |
| `g_split_n` | :30972 | `__sp_whole`, `dce_emit_module`, `split_emit_module` | Partitioned emission — see "Partitioned emission" below. |
| `g_split_out` | :30975 | `main` |  |
| `g_split_part` | :30976 | `split_emit_module` |  |
| `g_split_priv` | :30978 | `split_emit_module` |  |
