...
echo "[1/4] camera geometry vs the reference torch code"
...
echo "[2/4] frame preprocessing vs the reference load_fn pipeline"
...
echo "[3/4] position-grid resample vs torch bicubic+antialias"
...
echo "[4/4] 2-D rotary position embedding vs the reference"
