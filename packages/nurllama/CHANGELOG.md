...
has been serving 0.17.4 with different source ever since. That is what this
release closes.
...
**Do not use 0.17.3.** It shipped the pin change below with a stale
`--version` literal — the binary announced `0.17.2`, a version whose
