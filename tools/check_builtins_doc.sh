...
#   nurl_closure_own       — compiler-private closure-env ownership select
#   nurl_closure_slice_drop — compiler-emitted drop of a closure slice's envs
...
SKIP='^(llvm\.dbg\.declare|llvm\.trunc\.f32|llvm\.trunc\.f64|nurl_init|nurl_journal_push|nurl_journal_push_drop|nurl_journal_push_drop2|nurl_journal_forget|nurl_journal_forget_slot|nurl_ret_owned_get|nurl_ret_owned_set|nurl_ret_hown_get|nurl_ret_hown_set|nurl_vec_slot_clear_if|nurl_closure_own|nurl_closure_slice_drop|nurl_vec_drop|nurl_vec_clone|printf|strtod)$'
