...
# ============================================================
#  tools/repl/build.sh — build the `nurl repl` binary.
#
#  Stage:
#    1. Compile tools/repl/main.nu to LLVM IR using ./build/nurlc
#    2. Link with stdlib/runtime.o → ./build/nurl-repl
#
...
SRC="$ROOT_DIR/tools/repl/main.nu"
...
echo "[1/2] $SRC → build/nurl-repl.ll"
"$NURLC" "$SRC" > "$ROOT_DIR/build/nurl-repl.ll"
