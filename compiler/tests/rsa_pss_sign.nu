...
@ main → i {
    ...
    : ( Vec u ) mh ( sha256_pure ( bytes_from_str `pure NURL RSA-PSS regression` ) )
    : ( Vec u ) salt ( hx `202122232425262728292a2b2c2d2e2f303132333435363738393a3b3c3d3e3f` )
    : ( Vec u ) sig ( rsa_pss_sign_sha256 n d mh salt )
    : b ok1 ( rsa_pss_verify_sha256 n e sig mh )
    // wrong digest must NOT verify
    : ( Vec u ) bad ( sha256_pure ( bytes_from_str `different message` ) )
