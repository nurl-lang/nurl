...
@ main → i {
    ...
    ( nurl_println_int ( string_len s ) )  // 5
    ...
    ( nurl_println_int ( string_get s 0 ) )  // 65
    ( nurl_println_int ( string_get s 1 ) )  // 0
    ( nurl_println_int ( string_get s 2 ) )  // 66
    ( nurl_println_int ( string_get s 3 ) )  // 0
    ( nurl_println_int ( string_get s 4 ) )  // 67
