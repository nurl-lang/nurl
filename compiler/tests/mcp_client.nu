...
//   * mcp_response_result_field extracts the `result` object on success.
...
// success envelope and verify mcp_response_result_field extracts the inner
...
@ run_response_inspect → v {
    ...
    : ?Json got ( mcp_response_result_field resp2 )
    ?? got {
        T res → {
