// test_quoting.nu — Phase 3a RFC 4180 quoted-cell unit tests.

$ `stdlib/core/string.nu`
$ `stdlib/core/vec.nu`
$ `stdlib/ext/csv.nu`

@ check_cell *CSVTableA t i row i col s want s label → i {
    : s got ( csv_table_a_view t row col )
    ? == # i got 0 {
        ( nurl_print label ) ( nurl_print `: NULL view\n` )
        ^ 1
    } {}
    : i glen ( csv_table_a_view_len t row col )
...
@ main → i {
    ...
    : *CSVTableA t1 ( csv_table_a_from_string ( string_from `name,city\n"alice","new york"\n"bob","la"\n` ) )
    ? != ( csv_table_a_n_rows t1 ) 2 {
        ( nurl_print `  expected 2 rows, got ` ) ( nurl_print ( nurl_str_int ( csv_table_a_n_rows t1 ) ) ) ( nurl_print `\n` )
        = fails + fails 1
    } {}
    ...
    : *CSVTableA t2 ( csv_table_a_from_string ( string_from `name,note\n"smith, jr","greets, warmly"\nplain,unquoted\n` ) )
    ? != ( csv_table_a_n_rows t2 ) 2 {
        ( nurl_print `  expected 2 rows, got ` ) ( nurl_print ( nurl_str_int ( csv_table_a_n_rows t2 ) ) ) ( nurl_print `\n` )
        = fails + fails 1
    } {}
    ...
    : *CSVTableA t3 ( csv_table_a_from_string ( string_from `a,b\n"line1\nline2","x"\nplain,y\n` ) )
    ? != ( csv_table_a_n_rows t3 ) 2 {
        ( nurl_print `  expected 2 rows, got ` ) ( nurl_print ( nurl_str_int ( csv_table_a_n_rows t3 ) ) ) ( nurl_print `\n` )
        = fails + fails 1
    } {}
    ...
    : *CSVTableA t4 ( csv_table_a_from_string ( string_from `q,r\n"say ""hi""","done"\n` ) )
    ? != ( csv_table_a_n_rows t4 ) 1 {
        ( nurl_print `  expected 1 row, got ` ) ( nurl_print ( nurl_str_int ( csv_table_a_n_rows t4 ) ) ) ( nurl_print `\n` )
        = fails + fails 1
    } {}
    ...
    : *CSVTableA t5 ( csv_table_a_from_string ( string_from `x,y\n"""","ok"\n` ) )
    ...
    : *CSVTableA t6 ( csv_table_a_from_string ( string_from `a,b\n"","value"\n` ) )
    ...
    : *CSVTableA t7 ( csv_table_a_from_string ( string_from `a,b\r\n"aa","bb"\r\n"cc","dd"\r\n` ) )
    ? != ( csv_table_a_n_rows t7 ) 2 {
        ( nurl_print `  expected 2 rows, got ` ) ( nurl_print ( nurl_str_int ( csv_table_a_n_rows t7 ) ) ) ( nurl_print `\n` )
        = fails + fails 1
    } {}
    ...
    : *CSVTableA t8 ( csv_table_a_from_string ( string_from `a,b,c\n"x,y","say ""hi""","line1\nline2"\nplain,unquoted,plain\n` ) )
    ? != ( csv_table_a_n_rows t8 ) 2 {
        ( nurl_print `  expected 2 rows, got ` ) ( nurl_print ( nurl_str_int ( csv_table_a_n_rows t8 ) ) ) ( nurl_print `\n` )
        = fails + fails 1
    } {}
    : b w_ok ( csv_table_a_write t8 `/tmp/test_quoting_roundtrip.csv` ( csv_dialect_default ) )
    ? ! w_ok {
    ...
    : *CSVTableA t8b ( csv_table_a_load `/tmp/test_quoting_roundtrip.csv` )
    ? == # i t8b 0 {
